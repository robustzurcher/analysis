...
if __name__ == "__main__":
    ...
    grid_omega = np.round(np.linspace(0.00, spec['max_omega'], num=spec['num_points']), decimals=2)
    ...
    rslt = dict()
    for i, fname in enumerate(sorted(glob.glob('results/intermediate_*_spec["cost_func"].pkl'))):
